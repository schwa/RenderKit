...
kernel void voronoiNoiseCompute(
    constant float2 &size [[buffer(VoronoiNoiseComputeBindings_SizeBuffer)]],
    constant float2 &offset [[buffer(VoronoiNoiseComputeBindings_OffsetBuffer)]],
    constant short &mode [[buffer(VoronoiNoiseComputeBindings_ModeBuffer)]],
    texture2d<float, access::write> outputTexture [[texture(VoronoiNoiseComputeBindings_OutputTexture)]],
